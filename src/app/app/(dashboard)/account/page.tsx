...
async function cancelSubscriptionAction() {
  ...
  if (!paddleServer) {
    redirect("/app/account?error=billing_not_configured");
  }
  ...
  try {
    ...
    if (error instanceof PaddleSubscriptionCancelError) {
      redirect("/app/account?error=subscription_cancel_failed");
    }
...
async function deleteAccountAction(formData: FormData) {
  ...
  if (
    ...
    try {
      ...
      if (error instanceof PaddleSubscriptionCancelError) {
        redirect("/app/account?error=billing_cancel_failed");
      }
